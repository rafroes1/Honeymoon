...
//  Honeymoon
//
//  Created by Rafael Carvalho on 28/04/23.
//
        ...
        ScrollView(.vertical, showsIndicators: false) {
            VStack (alignment: .center, spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 25, content: {
                    ...
                    GuideComponent(title: "Book", subtitle: "Tap the button", description: "Our selection of honeymoon resosrts is perfect setting for you to embark your new life together.", icon: "checkmark.square")
                })
